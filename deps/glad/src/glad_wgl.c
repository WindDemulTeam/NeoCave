...
PFNWGLENUMGPUSNVPROC glad_wglEnumBlittersNV = NULL;
PFNWGLENUMGPUDEVICESNVPROC glad_wglEnumBlitterDevicesNV = NULL;
PFNWGLCREATEAFFINITYDCNVPROC glad_wglCreateAffinityDCNV = NULL;
PFNWGLENUMGPUSFROMAFFINITYDCNVPROC glad_wglEnumBlittersFromAffinityDCNV = NULL;
...
static void load_WGL_NV_gpu_affinity(GLADloadproc load) {
	...
	glad_wglEnumBlittersNV = (PFNWGLENUMGPUSNVPROC)load("wglEnumBlittersNV");
	glad_wglEnumBlitterDevicesNV = (PFNWGLENUMGPUDEVICESNVPROC)load("wglEnumBlitterDevicesNV");
	glad_wglCreateAffinityDCNV = (PFNWGLCREATEAFFINITYDCNVPROC)load("wglCreateAffinityDCNV");
	glad_wglEnumBlittersFromAffinityDCNV = (PFNWGLENUMGPUSFROMAFFINITYDCNVPROC)load("wglEnumBlittersFromAffinityDCNV");
